...
void print_python_list(PyObject *p) {
    ...
    for (i = 0; i < size; i++) {
        ...
        /* Print specific information based on element type */
...
/* Function to print basic info about Python byte objects */
...
/* Function to print basic info about Python float objects */
